...
df_product = df[["Assembly" ,"key2", "발주처", "견적화폐","청구품목", '리드타임',"Machinery" ,"Part No.1", "견적단가"]].copy()
df_product['id'] = df_product.index
# 여러 컬럼명 변경
df_product.rename(columns={'청구품목': 'item', '발주처': 'company',"견적화폐": "currency", 'Part No.1': 'partNo1',"리드타임" : "leadtime", "key2" : "category", "견적단가": "price"}, inplace=True)
